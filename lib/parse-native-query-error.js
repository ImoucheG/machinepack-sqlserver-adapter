module.exports = {
  ...
  fn: async function parseNativeQueryError({nativeQueryError, meta}, {success}) {
    ...
    footprint.keys = nativeQueryError.raw.precedingErrors ? nativeQueryError.raw.precedingErrors : nativeQueryError.raw.cause;
    const messagePreceding = nativeQueryError.raw.precedingErrors ? nativeQueryError.raw.precedingErrors.map(el => el.message + '\n') : '';
    return success({
      footprint: footprint,
